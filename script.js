...
// -----------------------------
const rods = [
  { name: "Driftwood Rod", cost: 0, luck: 0, speed: 0, weight: 35 },
  { name: "Emberfiber Rod", cost: 500, luck: 50, speed: 60, weight: 55 },
  { name: "Frostline Rod", cost: 750, luck: 30, speed: 92, weight: 90 },
  { name: "Verdantwhip Rod", cost: 4000, luck: 60, speed: 215, weight: 250 },
  { name: "Starcaller Rod", cost: 15000, luck: 100, speed: 320, weight: 625 },
  { name: "Stormcoil Rod", cost: 45000, luck: 200, speed: 245, weight: 5400 },
  { name: "Prismweave Rod", cost: 135000, luck: 450, speed: 630, weight: 10500 },
  { name: "Inferno Rod", cost: 545400, luck: 675, speed: 3685, weight: 92000 },
  { name: "Aether Rod", cost: 1204000, luck: 875, speed: 8595, weight: 340000 },
  { name: "Prismbloom Rod", cost: 4690000, luck: 1210, speed: 5484, weight: 720000 },
  { name: "Roselight Rod", cost: 15000000, luck: 1512, speed: 9583, weight: 2600000 },
  { name: "Leviathan Crown Rod", cost: 75000000, luck: 2832, speed: 21854, weight: 3200000 }, // preserved data; normalized by effectiveLuck()
];

const baits = [
  { name: "Dewdrop Pebble Bait", rarity: "Common", cost: 0, luck: 10 },
  { name: "Riverlily Bait", rarity: "Common", cost: 2000, luck: 30 },
  { name: "Firefly Pearl Bait", rarity: "Uncommon", cost: 4000, luck: 28 },
  { name: "Sunset Minnow Bait", rarity: "Uncommon", cost: 9000, luck: 45 },
  { name: "Moonpetal Swarm Bait", rarity: "Rare", cost: 30000, luck: 95 },
  { name: "Stormsong Shrimp Bait", rarity: "Rare", cost: 65000, luck: 150 },
  { name: "Opal Jelly Bait", rarity: "Epic", cost: 360000, luck: 270 },
  { name: "Emberrose Bait", rarity: "Epic", cost: 880000, luck: 290 },
  { name: "Aurora Bait", rarity: "Legendary", cost: 2400000, luck: 415 },
  { name: "Celestial Bait", rarity: "Mythic", cost: 8000000, luck: 540 },
  { name: "Leviathan Lullaby Bait", rarity: "Relic", cost: 26000000, luck: 750 }, // preserved data; normalized by effectiveLuck()
];

// -----------------------------
// Fish database (name, weight range in lbs, base value in $)
// -----------------------------
const fishDatabase = {
  "Mistvale Lake": {
    common: [
  ...
  "Whispering Tidepool": {
    ...
    secret5: [
      ["Serenity Sovereign", 767000, 1393000],
      ["Tranquil Eternus", 987654, 2345678],
    ],
  },
...
const rarityDisplay = {
  ...
  legendary: "Legendary",
  mythic: "Mythic",
  secret1: "Secret I (~1 in 250k)",
  secret2: "Secret II (~1 in 750k)",
  secret3: "Secret III (~1 in 2.5m)",
  secret4: "Secret IV (~1 in 7.5m)",
  secret5: "Secret V (~1 in 22m)",
};
